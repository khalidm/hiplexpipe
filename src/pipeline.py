...
def make_pipeline(state):
    ...
    pipeline.transform(
        ...
        # 9980078001_P06B05_HLLK5AFXX_CTGGACTC-AGAGATAG_L004_R1.fastq
        filter=formatter(
            '.+/(?P<sample>[a-zA-Z0-9-]+)_(?P<readid>[a-zA-Z0-9-]+)_(?P<index>[a-zA-Z0-9-]+)_(?P<lane>[a-zA-Z0-9]+)_R1_(?P<lib>[a-zA-Z0-9-:]+).fastq'),
